...
I am preparing for Fall 2027 PhD applications and have been studying your work around **NLP, question answering, efficient NLP, information extraction**. I was especially interested in the direction represented by **Open Information Extraction work; 2013; ACL**.

I put together a small research scaffold for a project I would like to develop further: **EvidenceLoop Research Agent: NLP for Balasubramanian-Aligned Research**. The goal is to build **a citation-faithful RAG and evaluation harness for advisor-domain papers** focused on **NLP**, with reproducible baselines, ablations, and failure analysis rather than a demo-only implementation.
...
Project summary: https://github.com/R-behera/ai-phd-p060-papertrail-synthesis-lab-balasubramanian
...
Public repo URL: https://github.com/R-behera/ai-phd-p060-papertrail-synthesis-lab-balasubramanian
