...
This repository is currently a **research proposal and execution scaffold**, not a completed result. Use it to show Professor Balasubramanian that you understand the research area and can contribute a concrete, reproducible artifact.
...
- **Research area from CSV:** NLP, question answering, efficient NLP, information extraction
- **Representative paper from CSV:** Open Information Extraction work; 2013; ACL
