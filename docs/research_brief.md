...
This project targets **NLP, question answering, efficient NLP, information extraction** with a concrete, reproducible artifact rather than a vague expression of interest. The goal is to show research taste, useful engineering, and honesty about what has and has not been completed.
