...
PaperTrail Synthesis Lab: NLP for Balasubramanian-Aligned Research

## Motivation

This project targets the intersection of **NLP, question answering, efficient NLP, information extraction** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Niranjan Balasubramanian's research area.
...
Advisor-specific slice: **NLP, question answering, efficient NLP, information extraction**.
