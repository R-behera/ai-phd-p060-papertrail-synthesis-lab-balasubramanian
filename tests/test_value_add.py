...
class ValueAddDemoTest(unittest.TestCase):
    def test_value_add_demo_runs(self):
        result = run_demo()
        self.assertEqual(result["professor"], 'Niranjan Balasubramanian')
    ...
    def test_profile_is_professor_specific(self):
        ...
        self.assertEqual(profile["research_area"], 'NLP, question answering, efficient NLP, information extraction')
